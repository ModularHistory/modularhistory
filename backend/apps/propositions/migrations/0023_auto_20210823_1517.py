...
def forwards_func(apps, schema_editor):
    ...
    EntityRelation = apps.get_model('propositions', 'EntityRelation')
    for proposition in Proposition.objects.all():
        for related_entity in proposition.related_entities.all():
            EntityRelation.objects.get_or_create(
                entity=related_entity, content_object=proposition
            )
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('propositions', '0022_auto_20210822_0311'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    core.fields.m2m_foreign_key.ManyToManyForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name='propositions_entityrelation_set',
                        to='entities.entity',
        ...
        migrations.AddField(
            ...
            field=apps.entities.models.model_with_related_entities.RelatedEntitiesField(
                blank=True,
                related_name='proposition_nre',
                through='propositions.EntityRelation',
                to='entities.Entity',
