    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('text', modularhistory.fields.HTMLField(paragraphed=True, processor=modularhistory.fields.html_field.process, verbose_name='Text')),
                ('bite', modularhistory.fields.HTMLField(blank=True, null=True, paragraphed=None, processor=modularhistory.fields.html_field.process, verbose_name='Bite')),
                ('pretext', modularhistory.fields.HTMLField(blank=True, help_text='Content to be displayed before the quote', null=True, paragraphed=False, processor=modularhistory.fields.html_field.process, verbose_name='Pretext')),
                ('context', modularhistory.fields.HTMLField(blank=True, help_text='Content to be displayed after the quote', null=True, paragraphed=True, processor=modularhistory.fields.html_field.process, verbose_name='Context')),
                ('date', modularhistory.fields.historic_datetime_field.HistoricDateTimeField(null=True)),
            ],
            options={
                'ordering': ['date'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quote', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='image_relations', to='quotes.quote')),
            ],
            options={
                'abstract': False,
            },
