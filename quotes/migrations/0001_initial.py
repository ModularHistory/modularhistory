    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('text', history.fields.html_field.HTMLField()),
                ('bite', history.fields.html_field.HTMLField(blank=True, null=True)),
                ('pretext', history.fields.html_field.HTMLField(blank=True, help_text='Content to be displayed before the quote', null=True)),
                ('context', history.fields.html_field.HTMLField(blank=True, help_text='Content to be displayed after the quote', null=True)),
