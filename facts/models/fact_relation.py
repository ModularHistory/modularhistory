...
class EntityFactRelation(FactRelation):
    ...
    fact = ForeignKey(
        'facts.Postulation', related_name='fact_entity_relations', on_delete=CASCADE
    )
...
class TopicFactRelation(FactRelation):
    ...
    fact = ForeignKey(
        'facts.Postulation', related_name='fact_topic_relations', on_delete=CASCADE
    )
...
class OccurrenceFactRelation(FactRelation):
    ...
    fact = ForeignKey(
        'facts.Postulation', related_name='fact_occurrence_relations', on_delete=CASCADE
    )
