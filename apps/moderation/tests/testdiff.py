...
# from apps.moderation.diff import (
#     ImageChange,
#     TextChange,
...
#             verbose_name='description', field=fields.CharField, change=('test1', 'test2')
#         )
...
#         self.assertIn(
#             "'userprofile__description': Change object: Old description - Old " 'description',
#             str(changes),
#         )
#         self.assertIn(
