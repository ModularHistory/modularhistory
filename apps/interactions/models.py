...
class Edit(FieldContentInteraction):
    ...
    user = models.ForeignKey(
        to='_account.User', related_name='edits', on_delete=models.CASCADE
    )
...
class Comment(FieldContentInteraction):
    ...
    user = models.ForeignKey(
        to='_account.User', related_name='comments', on_delete=models.CASCADE
    )
...
class Highlight(FieldContentInteraction):
    ...
    user = models.ForeignKey(
        to='_account.User', related_name='highlights', on_delete=models.CASCADE
    )
